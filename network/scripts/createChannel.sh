...
createChannelGenesisBlock() {
  setGlobals 1
	...
	if [ $bft_true -eq 1 ]; then
		configtxgen -profile ChannelUsingBFT -outputBlock ./channel-artifacts/channel1.block -channelID channel1
	else
...
joinChannel 1
infoln "Joining verifierA peer to the channel..."
joinChannel 2
infoln "Joining verifierB peer to the channel..."
joinChannel 3

## Set the anchor peers for each org in the channel
infoln "Setting anchor peer for applicant..."
setAnchorPeer 1
infoln "Setting anchor peer for verifierA..."
setAnchorPeer 2
infoln "Setting anchor peer for verifierB..."
setAnchorPeer 3
